    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col md:flex-row">
      ...
      {mobileMenuOpen && (
        <div className="md:hidden bg-slate-900 border-b border-slate-800 px-4 py-3 space-y-1">
          ...
          <Link href="/admin/deposits" onClick={() => setMobileMenuOpen(false)} className="block py-2.5 px-3 rounded-lg text-sm bg-blue-600/20 text-blue-400">Deposits</Link>
      ...
      <div className="flex-1 flex flex-col">
        ...
        <main className="p-4 md:p-6">
          <h1 className="md:hidden text-xl font-bold mb-4">Deposits Management</h1>
