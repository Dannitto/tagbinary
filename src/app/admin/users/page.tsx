  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 flex">
      ...
      <div className="flex-1 flex flex-col">
        ...
        <main className="p-6">
          <div className="mb-6">
            <p className="text-slate-400 text-sm">Manage all registered users. (Currently showing demo data.)</p>
          </div>
                ...
                {users.map((u) => (
                  <tr key={u.id} className="hover:bg-slate-800/40 transition">
                    ...
                    <td className="px-6 py-4">
                      <span className="text-green-400 text-xs font-medium bg-green-500/10 px-2.5 py-1 rounded-full">{u.status}</span>
                    </td>
